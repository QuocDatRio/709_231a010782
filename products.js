    ...
    storages: [
      {
        ...
        price: 36990000,
        colors: [
          { key: "natural", name: "Titan tự nhiên", hex: "#c4bfb6", photo: "images/iphone2.jpg" },
          { key: "black", name: "Titan đen", hex: "#3a3a3c", photo: "images/ip17prm.jpg" },
          { key: "white", name: "Titan trắng", hex: "#f5f5f7", photo: "images/iphone2.jpg" },
        ],
      },
      {
        gb: 512,
    ...
    storages: [
      {
        ...
        price: 18990000,
        colors: [
          { key: "black", name: "Đen", hex: "#1d1d1f", photo: "images/ip15.jpg" },
          { key: "blue", name: "Xanh dương", hex: "#d5e4f4", photo: "images/ip15(1).jpg" },
          { key: "green", name: "Xanh lá", hex: "#e0ebe2", photo: "images/ip15(1).jpg" },
          { key: "yellow", name: "Vàng", hex: "#fbf7d6", photo: "images/ip15(1).jpg" },
          { key: "pink", name: "Hồng", hex: "#f8e1e5", photo: "images/ip15(1).jpg" },
        ],
      },
      {
        gb: 256,
